			...
			<div class="col-md-12">
				...
				<div class="col-md-6">
					<div class="present_img">
						<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/image-1.png" alt="image">
					</div>
				</div>
			...
			<div class="col-md-6">
				...
				<div class="col-md-6">
					<div class="features_img pull-left">
						<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/features_img.png" alt="image">
					</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-7">
					<div class="services_img">
						<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/services_img1.png" alt="image-1">
					</div>
						
					<div class="services_img_n">
						<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/services_img2.png" alt="image-1">
					</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="col-md-4">
								<div class="workng_img">
									<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/how_to_work.png" alt="image">
								</div>
				</div>
			...
			<div class="col-md-12">
				...
				<div class="section_heading">
					...
					<div class="portfolio_img">
						<div class="port_img1">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/portfolio2.png" alt="image">
						</div>
					</div>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/member_1.png" alt="image">
						</div>
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/member_2.png" alt="image">
						</div>
						<div class="member_name">
							<h5> Marlon Leend</h5>
							<p> Head Phographer</p>
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/member_3.png" alt="image">
						</div>
						<div class="member_name">
							<h5> Robert Son</h5>
				...
				<div class="col-md-3">
					<div class="member_detail">
						<div class="member_img">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/member_4.png" alt="image">
						</div>
						<div class="member_name">
							<h5> John Capone</h5>
							<p> Web Art Director</p>
			...
			<div class="col-md-12">
				...
				<div class="testimonial_slide">
					<div class="testi_detail">
						<div class="testi_img">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/testi_img1.png" alt="image">
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-4">
					<article class="our_blog">
						<div class="blog_image">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/blog-img1.png" alt="image">
						</div>
						...
						<div class="blog_detail">
							<div class="category_heading">
								...
								<a href="http://test.webplus.az/wp-content/themes/AppLayers/blog.php" class="read_more"> <p> Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </p> </a>
							</div>
						</div>
					</article>					
				</div>
				...
				<div class="col-md-4">
					<article class="our_blog">
						<div class="blog_image">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/blog-img2.png" alt="image">
						</div>
				...
				<div class="col-md-4">
					<article class="our_blog">
						<div class="blog_image">
							<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/blog-img3.png" alt="image">
						</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<div class="col-md-4">
								<div class="workng_img">
									<img src="http://test.webplus.az/wp-content/themes/AppLayers/images/contact_img.png" alt="image">
								</div>
				</div>
